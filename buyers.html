...
<head>
    <meta charset="UTF-8">
    <title>QuickLandsDeals - For Land Buyers</title>
    ...
    <style>
        :root {
            ...
            --danger: #e53935;
            --modal-bg: #fff;
            --shadow: 0 4px 20px rgba(44,204,64,0.10);
            --border-contrast: #027a48;
        }
        body {
            ...
            min-height: 100vh;
            background:
                linear-gradient(135deg, rgba(22,183,72,0.15) 0%, rgba(26,144,255,0.15) 100%),
        ...
        .brand-title {
            ...
            letter-spacing: 1px;
            text-shadow: 0 2px 12px #fff, 0 2px 10px #001e0b22;
        }
...
<body>
    <div class="container">
        ...
        <div class="brand">
            <img src="logo.png" alt="Quick Lands Deals Logo" class="brand-logo" />
            ...
            <ul class="contracts-list">
                ...
                {% for file in site.static_files %}
                    {% if file.path contains '/contracts/' and file.extname == '.pdf' %}
                        ...
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24"><path fill="currentColor" d="M16 21v-2a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2"/>
